 ...
 *  @return Datatype: String
 *
 * If EITHER the number value is greater than or equal to 120 or the boolean value is true, then the function will return the message: Otherwise, return the message: "See you in summer school."
 * Console.log your result.
*/ 
...
console.log(graduation(120, 110));
...
function dailySpecials(day){
	switch (day){
	case "Monday":
	console.log("Today's special is Sushi.");
	break;
	case "Tuesday":
	console.log("Today's specilal is Tempura.");
	break;
	case "Wednesday":
	console.log("Today's special is Soba.");
	break;
	case "Thirsday":
	console.log("Today's special is Curry rice.");
	break;
	case "Friday":
	console.log("Today's specila is Sashimi");
	break;
	default:
	console.log("Sorry, no special on weekend");
    }
}
...
for (var num = 0; num<players.length; num++){
	console.log("Player " + players[num]);
}
